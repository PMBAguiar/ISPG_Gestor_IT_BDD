...
switch($filter){
    case 1: $query = "SELECT *
                        ...
                        WHERE ID_Posto IS NULL
                        ORDER BY Licenca_Software.ID_LIC ASC";
            break;

    case 2: $query = "SELECT Licenca_Software.*,Posto.Modelo_Posto
                        FROM Licenca_Software
                        INNER JOIN Posto ON Licenca_Software.ID_Posto=Posto.ID_Posto
                        ORDER BY Licenca_Software.ID_LIC ASC";
            break;

    default: $query = "SELECT Licenca_Software.*,Posto.Modelo_Posto
                        FROM Licenca_Software
                        LEFT JOIN Posto ON Licenca_Software.ID_Posto=Posto.ID_Posto
                        ORDER BY Licenca_Software.ID_LIC ASC";
             break;
                                        ...
                                        <table id="tblExport" class="table table-bordered table-hover table-striped" style>
                                            <thead style="background: #333333; color: white;">
                                                <tr>
                                                    ...
                                                    <th>Posto</th>
                                                    <th colspan=2>
                                                        <button onclick="location.href = 'Software_reg.php?modo=0&go=0';" class="btn-block btn-success" type="submit">
                                                ...
                                                <!-- Preencher dados da BD -->
                                                    ...
                                                    <?php 
                                                        ...
                                                        for ($i = 1; $i <= $showrow ; $i++) { 
                                                                ...
                                                                ?> 
                                                                    <td><?php echo $val['Nome_LIC'];?></td>
                                                                    <td><?php echo $val['Serial_LIC'];?></td>
                                                                    <td><?php echo $val['Fornecedor_LIC'];?></td>
                                                                    <td><?php echo $val['Modelo_Posto'];?></td>
                                                                    <td style="background: #333333; color: white;">
                                                                        <button onclick="location.href = 'Software_reg.php?modo=1&go=0&id=<?php echo $val['ID_LIC'];?>';" class="btn-block btn-success" type="submit">
                                                                            <i class="glyphicon glyphicon-edit"></i>
                                                                        </button>
                                                                    </td>

                                                                    <td style="background: #333333; color: white;">
                                                                        <button onclick="location.href = 'Software_del.php?id=<?php echo $val['ID_LIC'];?>';" class="btn-block btn-success" type="submit">
