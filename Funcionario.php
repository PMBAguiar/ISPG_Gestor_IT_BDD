...
switch($filter){
    case 1: $query = "SELECT Funcionario.*,Posto.Modelo_Posto, Area.Nome_Area 
                        FROM Funcionario
                        INNER JOIN Posto ON Funcionario.ID_Posto=Posto.ID_Posto
                        INNER JOIN Area ON Funcionario.ID_Posto=Area.ID_Area 
                        WHERE Funcionario.Ativo_Func=1 ORDER BY Funcionario.ID_Func ASC";
            break;

    case 2: $query = "SELECT Funcionario.*,Posto.Modelo_Posto, Area.Nome_Area 
                        FROM Funcionario
                        INNER JOIN Posto ON Funcionario.ID_Posto=Posto.ID_Posto
                        INNER JOIN Area ON Funcionario.ID_Posto=Area.ID_Area 
                        WHERE Funcionario.Ativo_Func=0 ORDER BY Funcionario.ID_Func ASC";
            break;

    default: $query = "SELECT Funcionario.*,Posto.Modelo_Posto, Area.Nome_Area 
                        FROM Funcionario
                        INNER JOIN Posto ON Funcionario.ID_Posto=Posto.ID_Posto
                        INNER JOIN Area ON Funcionario.ID_Posto=Area.ID_Area
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <div style="display: inline-block;">
                                <form action="Funcionario.php" method="POST">
                                    <button type="submit" name="stat" id="stat" value=1 class="btn btn-success">Ativos</button>
                                </form>
                            </div>

                            <div style="display: inline-block;">
                                <form action="Funcionario.php" method="POST">
                                    <button type="submit" name="stat" id="stat" value=2 class="btn btn-danger">Inativo</button>
                                </form>
                            </div>
                                        ...
                                        <table id="tblExport" class="table table-bordered table-hover table-striped" style>
                                            <thead style="background: #333333; color: white;">
                                                <tr>
                                                    ...
                                                    <th>Password</th>
                                                    <th colspan=2>
                                                        <button onclick="location.href = 'Funcionario_reg.php?modo=0&go=0';" class="btn-block btn-success" type="submit">
                                                    ...
                                                    <?php 
                                                        ...
                                                        for ($i = 1; $i <= $showrow ; $i++) { 
                                                                ...
                                                                ?> 
                                                                    ...
                                                                    <td><?php echo $val['Email_Func'];?></td>
                                                                    <td><?php echo $val['Handle_Func'];?></td>
                                                                    <td><?php echo $val['Nivel_Func'];?></td>
                                                                    <td><?php echo $val['Modelo_Posto'];?></td>
                                                                    <td><?php echo $val['Nome_Area'];?></td>
                                                                    <td><?php echo $val['Password_Func'];?></td>
                                                                    <td style="background: #333333; color: white;">
                                                                        <button onclick="location.href = 'Funcionario_reg.php?modo=1&go=0&id=<?php echo $val['ID_Func'];?>';" class="btn-block btn-success" type="submit">
                                                                            <i class="glyphicon glyphicon-edit"></i>
                                                                        </button>
                                                                    </td>

                                                                    <td style="background: #333333; color: white;">
                                                                        <button onclick="location.href = 'Funcionario_del.php?id=<?php echo $val['ID_Func'];?>';" class="btn-block btn-success" type="submit">
